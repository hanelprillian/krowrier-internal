                        ...
                        <div class="table-responsive table-scroll padding-right-10" style="max-height:520px;">
                            <table class="table table-hover mb-0">
                                ...
                                <tr>
                                    ...
                                    <td class="valign-top">
                                        <span class="text-primary">BK-190201-87326</span>
                                        <br>
                                        <small class="badge-text success badge-text-small">Active</small>
                                    </td>
                                    <td class="valign-top">Jhonny Prillian</td>
                                    <td class="valign-top">Laelnaldi</td>
                                    <td class="valign-top">One day service</td>
                                    <td class="valign-top">Stasiun Gambir</td>
                                    <td class="valign-top">Stasiun Bogor</td>
                                    <td class="valign-top">Taman bunga matahari</td>
