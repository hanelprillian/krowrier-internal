            ...
            <nav class="navbar fixed-top">
                ...
                <div class="navbar-holder d-flex align-items-center align-middle justify-content-between">
                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center pull-right">
                        ...
                        <!-- End Notifications -->
                        <!-- User -->
                        <li class="nav-item dropdown"><a id="user" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><img src="/images/user-no.png" alt="..." class="avatar rounded-circle"></a>
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a href="#dropdown-master-data" aria-expanded="false" data-toggle="collapse">
                                <i class="la la-list-alt"></i><span>Master Data</span>
                            </a>
                            <ul id="dropdown-master-data" class="collapse list-unstyled pt-0">
                                <li>
                                    <a href="#"><span>Service Package</span></a>
                                </li>
                                <li>
                                    <a href="#"><span>Data Hub</span></a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="#dropdown-transaction-data" aria-expanded="false" data-toggle="collapse">
                                <i class="la la-newspaper-o"></i><span>Booking & Transaction</span>
                            </a>
                            <ul id="dropdown-transaction-data" class="collapse list-unstyled pt-0">
                                ...
                                <li>
                                    <a href="#"><span>Booking Progress</span></a>
                                </li>
                                <li>
                                    <a href="#"><span>Customer</span></a>
                                </li>
                                <li>
                                    <a href="#"><span>Feeder</span></a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="la la-users"></i><span>Users</span></a>
                        </li>
                    </ul>
